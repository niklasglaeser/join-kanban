...
<div class="contact-right-container">
  ...
  <div class="contact-right-name">
    ...
    <a onclick="toogleDeleteWarn(${i})" class="pointer"><img src="./images/delete.svg" alt="">DELETE</a>
    </div>
  </div>
</div>
<div>
...
<div id="edit-more" class="edit-more" onclick="toogleInfoEditMobile()">
  ...
  <div onclick="toogleDeleteWarn(${i})" class="pointer"><img src="./images/delete.svg" alt="">Delete</div>
</div>
</div>
</div>
`;
